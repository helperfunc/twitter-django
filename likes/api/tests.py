...
class LikeApiTests(TestCase):
    ...
    def test_likes_in_comments_api(self):
        ...
        self.assertEqual(response.data['comments'][0]['has_liked'], 1)
    ...
    def test_likes_in_tweets_api(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response.data['newsfeeds'][0]['has_liked'], True)
        self.assertEqual(response.data['newsfeeds'][0]['likes_count'], 2)
